...
Route::middleware(ApiAuthMiddleware::class)->group(function(){
    ...
    Route::post('/contacts/{idContact}/addresses', [AddressController::class, 'create'])->whereNumber('idContact');
    Route::get('/contacts/{idContact}/addresses', [AddressController::class, 'list'])->whereNumber('idContact');
    Route::get('/contacts/{idContact}/addresses/{idAddress}', [AddressController::class, 'get'])
        ->whereNumber('idContact')
        ->whereNumber('idAddress');
